...
<div class="a1">
 ...
 <% } %>
  ...
  <div class="a1">
    ...
    <p align="center">Add Notebook</p>
	<p align="center" ><input type="text" name="name" placeholder="note name" required="required" /></p>
	<p align="center"><input type="text" name="status" placeholder="note status" required="required" /></p>
    <p align="center"><input type="text" name="description" placeholder="description" required="required" /></p>
	<br>
    <p class="c1">start date</p> <input type="date" name="startdate" class="c" placeholder="start date" required="required" />
	<br><br>
    <p class="c1">end date</p> <input type="date" name="enddate" class="c" placeholder="end date" required="required" />
    <br><br>
    <p class="c1">reminder date</p> <input type="date" name="reminderdate" class="c" placeholder="reminder date" required="required" />
    <br><br>
    <p style="text-align:center"><button type="submit">add</button></p>
    </form>
  </div>
</div>
</div>
		  <div class="c"><a href="view">view</a></div>
          ...
          <div id="myModal1" class="modal1">
            ...
            <div class="a1">
              ...
              <p align="center">Edit Notebook</p>
              <br>
