  ...
  <strong>Warning!</strong> password mismatch
        ...
        <div class="login-container text-c animated flipInX">
                ...
                <div class="container-content">
                    <form class="margin-t" method="post" action="signup">
                        ...
                        <br>
                        <div class="form-group">
                            <input type="password" name="password1" class="form-control" placeholder="repeat password" required="">
                        </div>
                        <br>
                        <button type="submit" class="form-button button-l margin-b">Sign Up</button>
        				<br>
                        <p class="text-whitesmoke text-center"><small>Do have an account?</small></p>
                        <a class="text-darkyellow" href=login1.jsp><small>login</small></a>
                    </form>
                </div>
            </div>
            <script>
